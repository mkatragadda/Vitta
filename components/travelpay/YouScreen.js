...
const SettingsRow = ({ label, right, danger }) => (
  <div style={{
    ...
    <span style={{ color: danger ? '#ff6b6b' : '#fff', fontSize: 12, fontWeight: 600 }}>{label}</span>
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'rgba(255,255,255,0.22)', fontSize: 12 }}>
      {right}
  ...
  return (
    <div style={{ minHeight: '100%', paddingBottom: 80 }}>
      ...
      <div style={{ padding: '18px 20px 10px', display: 'flex', alignItems: 'center' }}>
        <span style={{ color: '#fff', fontSize: 17, fontWeight: 700, letterSpacing: '-0.3px' }}>You</span>
      </div>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ color: 'rgba(255,255,255,0.34)', fontSize: 11, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{email}</div>
        </div>
      </div>
      ...
      <SectionGroup title="Support">
        ...
        <div
          ...
          style={{
            ...
            padding: '11px 14px', background: '#0d1f1a', cursor: 'pointer',
          }}
        >
      ...
      <div style={{ textAlign: 'center', color: 'rgba(255,255,255,0.14)', fontSize: 10, paddingTop: 4 }}>
        Vitta · v1.0.0
      </div>
    </div>
  );
